...
import { posthogHost, posthogKey } from './posthog';
 ...
 * only its public (project) value is ever inlined. `person_profiles:
...
posthog.init(${JSON.stringify(key)},{api_host:${JSON.stringify(host)},person_profiles:'identified_only',capture_pageview:true,capture_pageleave:true});`;
  return <Script id="posthog-init" strategy="afterInteractive">{snippet}</Script>;
}
