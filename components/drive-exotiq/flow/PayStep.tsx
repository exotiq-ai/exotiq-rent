    ...
    <>
      <ScreenShell>
        <StepHeader
          eyebrow="Step 07"
          title="Final payment."
          sub="The operator rental charge is separated from Exotiq.Rent platform and protection lines before Stripe collection."
        />
        ...
        <div className="mt-4 rounded-xl border border-[#2A2E3A] bg-[#161922] p-4 text-sm">
          ...
          <div className="mt-2 text-xs leading-5 text-[#5C6272]">Collected for {cart.operator.name}; includes rental, selected extras, and operator taxes/fees.</div>
          ...
          <div className="mt-3 flex justify-between gap-3 border-t border-[#2A2E3A] pt-3 font-medium text-[#F0F2F5]">
            <span>Exotiq pass-through total</span>
        ...
        <div className="mt-4 rounded-xl border border-[#2A2E3A] bg-[#161922] p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs leading-5 text-[#9BA1B0]">Exotiq platform fee and protection plan should pass through Stripe to Exotiq and appear on the customer statement as <span className="text-[#F0F2F5]">exotiq.rent</span>.</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-[#2A2E3A] bg-[#161922] p-4"><div className="flex items-center gap-3"><div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#C8A664]/10 text-[#C8A664]"><CreditCard size={18} /></div><div className="flex-1"><div className="text-sm font-medium">Tokenized card placeholder</div><div className="mt-1 text-xs text-[#9BA1B0]">Ready for Stripe Elements / Payment Element; no card data enters app state.</div></div></div></div>
