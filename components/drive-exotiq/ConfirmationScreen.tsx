    ...
    <PhoneViewport step={8} className="font-[var(--font-drive-inter)]">
      <section className="flex-1 overflow-y-auto px-4 pb-8 pt-2 [scrollbar-width:none]">
        ...
        <div className="mt-4 rounded-xl border border-[#2A2E3A] bg-[#161922] p-4">
          ...
          <div className="flex justify-between border-t border-[#2A2E3A] py-3 text-sm"><span><span className="block">Operator rental charge</span><span className="text-xs text-[#C8A664]">Operator share transfers automatically</span></span><Money cents={cart.totals.operatorTotalCents} /></div>
          <div className="flex justify-between border-t border-[#2A2E3A] py-3 text-sm"><span><span className="block">Exotiq platform fee ({platformPercent}%)</span><span className="text-xs text-[#C8A664]">Deposit excluded</span></span><Money cents={cart.totals.platformFeeCents} /></div>
