        ...
        <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_22rem] lg:items-start lg:gap-x-12">
          <div className="min-w-0">
            ...
            <div className="mt-4 rounded-xl border border-[#2A2E3A] bg-[#161922] p-4 lg:hidden">
              ...
              <div className="grid grid-cols-3 gap-2 text-center text-[11px]">
                ...
                <div className="rounded-lg bg-[#1E2230] p-3"><div className="text-[17px] font-medium leading-none tabular-nums text-[#C8A664]">{vehicle.minRentalDays}<span className="text-[11px] font-normal text-[#848A9A]"> {vehicle.minRentalDays === 1 ? 'day' : 'days'}</span></div><div className="mt-1.5 text-[#848A9A]">Minimum</div></div>
          ...
          <aside className="hidden lg:sticky lg:top-6 lg:block">
            <div className="rounded-2xl border border-[#2A2E3A] bg-[#161922] p-6">
              <div className="text-[11px] uppercase tracking-[0.18em] text-[#848A9A]">{operator.name}</div>
              <div className="mt-3 flex items-baseline gap-2 text-[#C8A664]">
                <Money cents={vehicle.dailyRateCents} large />
                <span className="text-[11px] uppercase tracking-[0.16em] text-[#848A9A]">per day</span>
              </div>
